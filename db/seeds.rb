...
phil = User.create!(name:'phil', password: "123", age: 36, background_information: Faker::Hipster.paragraph(2), image:'https://avatars1.githubusercontent.com/u/12497818?v=3&s=400')
