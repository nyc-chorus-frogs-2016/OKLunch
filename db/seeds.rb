...
20.times do
User.create!(username: Faker::Name.name, password: "123", age: Faker::Number.number(2), interests: Faker::Hipster.sentences(1), background_information: Faker::Hipster.paragraph(2))
end
